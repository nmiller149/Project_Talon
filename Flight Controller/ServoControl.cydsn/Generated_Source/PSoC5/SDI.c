...
*
* \funcusage
*  \snippet SDI_SUT.c usage_SDI_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet SDI_SUT.c usage_SDI_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet SDI_SUT.c usage_SDI_Read  
*******************************************************************************/
uint8 SDI_Read(void)
{
...
* preferred SDI_Read() API because the 
* SDI_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet SDI_SUT.c usage_SDI_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: SDI_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use SDI_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - SDI_0_INTR       (First pin in the list)
    *  - SDI_1_INTR       (Second pin in the list)
    *  - ...
    *  - SDI_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet SDI_SUT.c usage_SDI_SetInterruptMode
    *******************************************************************************/
    void SDI_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & SDI_0_INTR) != 0u) 
		{ 
			 SDI_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet SDI_SUT.c usage_SDI_ClearInterrupt
    *******************************************************************************/
