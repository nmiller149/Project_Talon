 ...
 *    -  Completed Build = Now fully functional
 *    - 
 *    -
 *
**/
...
//uint8* readBMP280(uint8 regAddr, uint8 bytes){
//    static uint8 tmp[10];
//    
//    //SPIM_1_ClearTxBuffer();
//    BMP280_CSB_Write(0);
//    SPIM_1_ClearRxBuffer();
//    SPIM_1_WriteByte(regAddr++ | 0x80); //Write Address in read mode
...
//    {
//        int32 timeOut = 0;      
//		SPIM_1_WriteByte(regAddr++); //Write dummy byte       
//		while(SPIM_1_GetRxBufferSize() ==0 && timeOut < 500000) 
//		{                                                       
//			timeOut++;
//		}
//		if (timeOut >=500000)
